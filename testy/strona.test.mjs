...
test('blok zgody (Consent Mode, Cookiebot, GA4, HubSpot, piksel Meta) identyczny na każdej stronie publicznej', () => {
  const wyciag = (h) => ({ ga: /G-XHZDND4X1W/.test(h), cb: /data-cbid="7a55c023-e775-4510-b1af-bdb8eaadfff5"/.test(h), hs: /49004516\.js/.test(h), meta: /<script type="text\/plain" data-cookieconsent="marketing">\s*!function\(f,b,e,v,n,t,s\)[\s\S]*?fbq\('init', '1032857169399673'\);\s*fbq\('track', 'PageView'\);\s*<\/script>/.test(h), consent: /gtag\('consent', 'default'/.test(h) });
  for (const s of ['index.html', 'pompy.html', 'dla-instalatorow.html', 'odwierty-pod-pompe-ciepla.html', 'dolne-zrodlo-pompy-ciepla.html', 'sondy-koszowe-helix.html', 'gruntowa-pompa-ciepla-cena.html', 'dotacje-pompa-ciepla.html', 'pompa-ciepla-czy-warto.html', 'gdzie-dzialamy/wielkopolskie.html', 'gdzie-dzialamy/lodzkie.html', 'gdzie-dzialamy/kujawsko-pomorskie.html', 'gdzie-dzialamy/dolnoslaskie.html', 'gdzie-dzialamy/slaskie.html', 'gdzie-dzialamy/mazowieckie.html', 'zgoda-na-publikacje-opinii.html', 'podziekowanie.html', '404.html']) assert.deepEqual(wyciag(html[s]), { ga: true, cb: true, hs: true, meta: true, consent: true }, s);
});
