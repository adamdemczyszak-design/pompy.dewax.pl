...
test('blok zgody (Consent Mode, Cookiebot, GA4, HubSpot, piksel Meta) identyczny na każdej stronie publicznej', () => {
  const wyciag = (h) => ({ ga: /G-XHZDND4X1W/.test(h), cb: /data-cbid="7a55c023-e775-4510-b1af-bdb8eaadfff5"/.test(h), hs: /49004516\.js/.test(h), meta: /<script type="text\/plain" data-cookieconsent="marketing">\s*!function\(f,b,e,v,n,t,s\)[\s\S]*?fbq\('init', '965779382154454'\);\s*fbq\('track', 'PageView'\);\s*<\/script>/.test(h), consent: /gtag\('consent', 'default'/.test(h) });
