...
| 10.17 | Raport tygodniowy | Zaplanowany 13.09.2026: w każdy poniedziałek o 7:00 Claude odświeża `wyniki.json` z Windsor.ai i HubSpota, scala na `main`, odświeża panel i wysyła krótki raport (leady, koszt zapytania, stan limitów). Tylko odczyt, bez zmian w Meta. |
