...
| 11.2 | **Środki na koncie.** Konto jest przedpłacone; środki skończyły się 25.08.2026 w środku dnia (stara kampania wydała 35 zł z 75 zł i stanęła), od 26.08 zero wyświetleń. Doładowanie z 12.09 o 20:30 nie było jeszcze zaksięgowane: wszystkie kampanie „niekwalifikujące się” z powodu na poziomie konta. Sprawdzić Rozliczenia → Podsumowanie (status wpłaty, saldo): karta księguje się w kilka godzin, przelew do 5 dni roboczych. Jeśli saldo jest dodatnie, a reklam nie ma, sprawdzić pasek powiadomień (weryfikacja reklamodawcy, profil płatności). | Bez środków Google nie wyświetli żadnej kampanii, niezależnie od ustawień. Dziennik: `docs/GOOGLE-ADS.md` punkt 11. |
