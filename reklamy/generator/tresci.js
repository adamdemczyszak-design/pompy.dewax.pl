...
window.DX_TRESCI = {
  ...
  specjalne: [
    ...
    { kod: 'bud-3', typ: 'marka', nazwa: 'Buderus: cicho w domu', korzysc: 'brak jednostki na elewacji', wezwanie: 'bez telefonu', kotwica: '',
      ...
      zrodlo: 'pompy.html, sekcja „Buderus” (montujemy również gruntowe pompy Buderus, cena w wycenie); index.html, FAQ „Montujecie tylko Thermokrafft?”; dolne-zrodlo-pompy-ciepla.html (dolne źródło pod Buderus wykonujemy sami); index.html, porównanie grunt/powietrze', uwaga: 'Przed wysłaniem: (1) właściciel potwierdza dokładny status partnerski Buderus (Autoryzowany Partner Handlowy, Top Partner albo Autoryzowany Instalator) i model, który DEWAX montuje; (2) zdjęcie z portalu partnerskiego Buderus albo własne; (3) logo Buderus tylko według zasad co-brandingu z portalu. W tekście celowo nie ma tytułu partnerskiego ani parametrów urządzenia.' },
    { kod: 'rm-1', typ: 'remarketing', nazwa: 'Remarketing: wróć do wyniku', korzysc: 'jeden wykonawca', wezwanie: 'bez telefonu', kotwica: '',
      tekst: 'Byłeś już na pompy.dewax.pl. Kalkulator pokazał Ci koszt, a decyzja dojrzewa.\n\nTo normalne. Pompa gruntowa to zakup na lata, nie na jeden wieczór. Gdy będziesz gotów, czekamy z tym samym: własna wiertnica, jedna umowa na odwierty i pompę, serwis po montażu.\n\nWróć do wyniku kalkulatora albo od razu zamów dokładną wycenę. Bez telefonu, odpowiadamy mailem.',
      naglowek: 'Wróć do swojego wyniku', opis: 'Jedna umowa, własna wiertnica', foto: 'odwiert-przy-domu',
      zrodlo: 'index.html (kalkulator, sekcja #geo: raport z danych PIG-PIB bez logowania, „jedna firma, jedna umowa”, formularz wyceny bez telefonu); zasada z rozmów z właścicielem: „Sprawdź to, zanim ktoś Ci ją sprzeda”', uwaga: 'Remarketing: reklama tylko dla osób, które były na pompy.dewax.pl w ciągu 30 dni i nie wysłały zapytania. Wymaga grupy odbiorców z piksela (CONTENT_NEEDED 10.15). Bez tej grupy nie uruchamiać jako zwykłej reklamy.' },
    { kod: 'rm-2', typ: 'remarketing', nazwa: 'Remarketing: sprawdź działkę', korzysc: 'koszt ogrzewania', wezwanie: 'sprawdź działkę', kotwica: '#geo',
      tekst: 'Sprawdziłeś koszt. Sprawdź jeszcze działkę, zanim ktoś sprzeda Ci pompę bez odwiertu.\n\nRaport geologiczny z danych PIG-PIB pokazuje, co masz pod ziemią i ile metrów odwiertu ma sens. Bez logowania, bez telefonu od handlowca.\n\nGdy obie liczby się zgadzają, wyślij zapytanie. Odpowiemy wyceną na mail.',
      naglowek: 'Sprawdź działkę, zanim kupisz', opis: 'Raport z danych PIG-PIB', foto: 'sonda-w-otworze',
      zrodlo: 'index.html (kalkulator, sekcja #geo: raport z danych PIG-PIB bez logowania, „jedna firma, jedna umowa”, formularz wyceny bez telefonu); zasada z rozmów z właścicielem: „Sprawdź to, zanim ktoś Ci ją sprzeda”', uwaga: 'Remarketing: reklama tylko dla osób, które były na pompy.dewax.pl w ciągu 30 dni i nie wysłały zapytania. Wymaga grupy odbiorców z piksela (CONTENT_NEEDED 10.15). Bez tej grupy nie uruchamiać jako zwykłej reklamy.' }
  ],
  zasady: {
